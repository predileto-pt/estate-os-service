...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_contract_source_documents_org", "contract_source_documents", ["organization_id"]
    )
    ...
    op.create_index(
        "idx_contract_source_parse_runs_doc", "contract_source_parse_runs", ["source_document_id"]
    )
    ...
    op.create_index(
        "idx_contract_source_sections_doc_order",
        "contract_source_sections",
    ...
    op.create_index(
        "idx_contract_source_extraction_runs_doc",
        "contract_source_extraction_runs",
        ["source_document_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_extraction_run_id", sa.dialects.postgresql.UUID(as_uuid=False), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["source_extraction_run_id"], ["contract_source_extraction_runs.id"]
        ),
        sa.ForeignKeyConstraint(["source_section_id"], ["contract_source_sections.id"]),
    )
    op.create_index(
        "idx_contract_source_field_evidence_run_key",
        "contract_source_field_evidence",
        ["source_extraction_run_id", "field_key"],
    )
    ...
    op.create_index(
        "idx_contract_analysis_runs_doc",
        "contract_source_section_analysis_runs",
        ["source_document_id"],
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_section_analysis_run_id"], ["contract_source_section_analysis_runs.id"]
        ),
        sa.ForeignKeyConstraint(["source_section_id"], ["contract_source_sections.id"]),
    )
    op.create_index(
        "idx_contract_analyses_run_section",
        "contract_source_section_analyses",
        ["source_section_analysis_run_id", "source_section_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_section_analysis_id", sa.dialects.postgresql.UUID(as_uuid=False), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["source_section_analysis_id"], ["contract_source_section_analyses.id"]
        ),
    )
    op.create_index(
        "idx_contract_analysis_refs",
        "contract_source_section_analysis_references",
    ...
    op.create_table(
        ...
        sa.Column(
            "contract_template_id", sa.dialects.postgresql.UUID(as_uuid=False), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(["source_document_id"], ["contract_source_documents.id"]),
        sa.UniqueConstraint(
            "contract_template_id", "version_number", name="uq_contract_template_versions_num"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "template_version_id", sa.dialects.postgresql.UUID(as_uuid=False), nullable=False
        ),
    ...
    op.create_index(
        "idx_contract_template_sections_version",
        "contract_template_sections",
    ...
    op.create_index(
        "idx_contract_field_bindings_version_key",
        "contract_template_field_bindings",
    ...
    op.create_index(
        "idx_contract_generated_contracts_org", "contract_generated_contracts", ["organization_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "generated_contract_id", sa.dialects.postgresql.UUID(as_uuid=False), nullable=False
        ),
        sa.Column("role_key", sa.String(50), nullable=False),
    ...
    op.create_index(
        "idx_contract_gen_parties",
        "contract_generated_contract_parties",
        ["generated_contract_id", "role_key", "party_order"],
    )
    ...
    op.create_index(
        "idx_contract_gen_sections",
        "contract_generated_contract_sections",
        ["generated_contract_id", "sort_order"],
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_contract_field_bindings_version_key", table_name="contract_template_field_bindings"
    )
    ...
    op.drop_index(
        "idx_contract_analysis_refs", table_name="contract_source_section_analysis_references"
    )
    op.drop_table("contract_source_section_analysis_references")
    op.drop_index(
        "idx_contract_analyses_run_section", table_name="contract_source_section_analyses"
    )
    op.drop_table("contract_source_section_analyses")
    op.drop_index(
        "idx_contract_analysis_runs_doc", table_name="contract_source_section_analysis_runs"
    )
    op.drop_table("contract_source_section_analysis_runs")
    op.drop_index(
        "idx_contract_source_field_evidence_run_key", table_name="contract_source_field_evidence"
    )
    op.drop_table("contract_source_field_evidence")
    op.drop_index(
        "idx_contract_source_extraction_runs_doc", table_name="contract_source_extraction_runs"
    )
