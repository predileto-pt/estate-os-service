...
from customer_management.adapters.api.middleware import JWTAuthMiddleware, RequestLoggingMiddleware
from customer_management.adapters.api.routes import auth, companies, email, health, notifications, subscriptions, users
from customer_management.config import settings, setup_logging
