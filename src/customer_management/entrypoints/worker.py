...
from customer_management.adapters.queue.sqs_consumer import SQSMessageConsumer
from customer_management.adapters.workers.events_worker import EventsWorker
