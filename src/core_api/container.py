...
from core_api.application.use_cases.manage_subscription import CreateSubscription, UpdateSubscription
...
class Container:
    def __init__(
        ...
        self.mark_notifications_read = MarkNotificationsRead(
