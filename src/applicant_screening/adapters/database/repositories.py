...
from applicant_screening.adapters.database.models import (
    ApplicantModel,
    DocumentModel,
    EventModel,
    ExtractedDataModel,
...
from applicant_screening.application.crypto import compute_blind_index, decrypt_field, encrypt_field
...
class SqlAlchemyEventRepository:
    ...
    @staticmethod
    def _to_domain(model: EventModel) -> DomainEvent:
        return DomainEvent(
            id=model.id,
            applicant_id=model.applicant_id,
